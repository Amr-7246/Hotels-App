  ...
  return (
    <div className='monitor-schema py-5 max-w-[400px] h-[400px] '>
        ...
        <div className='monitor-schema overflow-hidden !w-[300px] !h-[220px]'>
            <div className={`bg-rose-900 w-[200px] shadow-xl shadow-stone-800 h-[200px] overflow-hidden rounded-full`}>
                <div className={`bg-sky-900 w-[100px] h-[100px] relative `} > 
                    <span className={`absolute top-[40%] font-bold text-orange-950 rotate-[-45deg] `} > Clints Issues </span>
                </div>
            </div>
        </div>
    </div>
